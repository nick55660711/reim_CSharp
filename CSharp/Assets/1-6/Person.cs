  ...
  public void Talk()
    {
        ...
        // gameObject 套用此腳本的物件
        // gameObject.name 套用此腳本的物件 的名稱
       
        print("嗨，我是" + gameObject.name);
   ...
   public float BMI()
    ...
    /// 走路方法
    /// </summary>
    /// <param name="speed">以多少速度走路</param>

    public void Walk(int speed, string direction = "前方",string sound = "咖咖咖" , string equip = "拳")
    {
